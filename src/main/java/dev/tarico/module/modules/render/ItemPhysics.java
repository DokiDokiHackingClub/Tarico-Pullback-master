...
public class ItemPhysics extends Module {
    ...
    public final ModeValue<PhysicModes> mode = new ModeValue<>("ItemPhysics Mode", PhysicModes.values(), PhysicModes.Realistic);
    private final Random random;

    public ItemPhysics() {
        super("ItemPhysics", "ItemRender", ModuleType.Render);
        random = new Random();
    }
