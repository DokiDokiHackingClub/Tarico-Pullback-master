...
public class RotationUtil {
    ...
    public static float pitch() {
        return Module.mc.thePlayer.rotationPitch;
    }

    public static void pitch(float pitch) {
        Module.mc.thePlayer.rotationPitch = pitch;
    }

    public static float yaw() {
        return Module.mc.thePlayer.rotationYaw;
    }

    public static void yaw(float yaw) {
        Module.mc.thePlayer.rotationYaw = yaw;
    }
    ...
    public static float[] faceTarget(Entity target, float p_706252, float p_706253, boolean miss) {
        double var6;
        double var4 = target.posX - Module.mc.thePlayer.posX;
        double var8 = target.posZ - Module.mc.thePlayer.posZ;
        if (target instanceof EntityLivingBase) {
            EntityLivingBase var10 = (EntityLivingBase) target;
            var6 = var10.posY + (double) var10.getEyeHeight() - (Module.mc.thePlayer.posY + (double) Module.mc.thePlayer.getEyeHeight());
        } else {
            var6 = (target.getEntityBoundingBox().minY + target.getEntityBoundingBox().maxY) / 2.0 - (Module.mc.thePlayer.posY + (double) Module.mc.thePlayer.getEyeHeight());
        }
        ...
        float pitch = RotationUtil.changeRotation(Module.mc.thePlayer.rotationPitch, var13, p_706253);
        float yaw = RotationUtil.changeRotation(Module.mc.thePlayer.rotationYaw, var12, p_706252);
    ...
    public static double[] getRotationToEntity(Entity entity) {
        double pX = Module.mc.thePlayer.posX;
        double pY = Module.mc.thePlayer.posY + (double) Module.mc.thePlayer.getEyeHeight();
        double pZ = Module.mc.thePlayer.posZ;
    ...
    public static float[] getRotations(Entity entity) {
        ...
        double diffX = entity.posX - Module.mc.thePlayer.posX;
        double diffZ = entity.posZ - Module.mc.thePlayer.posZ;
        if (entity instanceof EntityLivingBase) {
            EntityLivingBase elb = (EntityLivingBase) entity;
            diffY = elb.posY + ((double) elb.getEyeHeight() - 0.4) - (Module.mc.thePlayer.posY + (double) Module.mc.thePlayer.getEyeHeight());
        } else {
            diffY = (entity.getEntityBoundingBox().minY + entity.getEntityBoundingBox().maxY) / 2.0 - (Module.mc.thePlayer.posY + (double) Module.mc.thePlayer.getEyeHeight());
        }
    ...
    public static float[] grabBlockRotations(BlockPos pos) {
        return RotationUtil.getVecRotation(Module.mc.thePlayer.getPositionVector().addVector(0.0, Module.mc.thePlayer.getEyeHeight(), 0.0), new Vec3((double) pos.getX() + 0.5, (double) pos.getY() + 0.5, (double) pos.getZ() + 0.5));
    }

    public static float[] getVecRotation(Vec3 position) {
        return RotationUtil.getVecRotation(Module.mc.thePlayer.getPositionVector().addVector(0.0, Module.mc.thePlayer.getEyeHeight(), 0.0), position);
    }
