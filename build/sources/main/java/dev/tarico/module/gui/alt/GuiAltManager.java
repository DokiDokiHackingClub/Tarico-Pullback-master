...
public class GuiAltManager extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 6) {
            mc.displayGuiScreen(new GuiCustomMainMenu(2));
        }
    ...
    private void login() {
        ...
        if (passwordField.getText().length() == 0) {
            Session session = SessionHelper.createOfflineSession(usernameField.getText(), Proxy.NO_PROXY);
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiButton(3, width / 2 - 250 / 2, height / 2 - 220 + 150 + 40 * 3, 80, 20, "Offline"));
